			...
			case "first":
				if ( game.selectedCard != null ) {
					...
					if ( game.columns.first[ game.columns.first.length - 1 ].visible ) {
						game.selectCard( "first", game.whichIndex( y, "first" ) );
					} else {
			...
			case "second":
				if ( game.selectedCard != null ) {
					...
					if ( game.columns.second[ game.columns.second.length - 1 ].visible ) {
						game.selectCard( "second", game.whichIndex( y, "second" ) );
					} else {
			...
			case "third":
				if ( game.selectedCard != null ) {
					...
					if ( game.columns.third[ game.columns.third.length - 1 ].visible ) {
						game.selectCard( "third", game.whichIndex( y, "third" ) );
					} else {
			...
			case "fourth":
				if ( game.selectedCard != null ) {
					...
					if ( game.columns.fourth[ game.columns.fourth.length - 1 ].visible ) {
						game.selectCard( "fourth", game.whichIndex( y, "fourth" ) );
					} else {
			...
			case "fifth":
				if ( game.selectedCard != null ) {
					...
					if ( game.columns.fifth[ game.columns.fifth.length - 1 ].visible ) {
						game.selectCard( "fifth", game.whichIndex( y, "fifth" ) );
					} else {
			...
			case "sixth":
				if ( game.selectedCard != null ) {
					...
					if ( game.columns.sixth[ game.columns.sixth.length - 1 ].visible ) {
						game.selectCard( "sixth", game.whichIndex( y, "sixth" ) );
					} else {
